...
const realtime_event_listener_1 = require("./realtime-event.listener");
...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [realtime_gateway_1.RealtimeGateway, realtime_event_listener_1.RealtimeEventListener],
