...
export declare class NotesService {
    ...
    create(createNoteDto: CreateNoteDto, createdById: string): Promise<{
        createdBy: {
            id: string;
            firstName: string;
            lastName: string;
    ...
    addComment(noteId: string, text: string, commentById: string): Promise<{
        commentBy: {
            id: string;
            firstName: string;
            lastName: string;
    ...
    markAsRead(noteId: string, employeeId: string): Promise<{
        id: string;
        readAt: Date;
        employeeId: string;
        noteId: string;
