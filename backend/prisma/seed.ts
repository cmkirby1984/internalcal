...
async function main() {
  ...
  const suiteTypes = ['STANDARD', 'DELUXE', 'SUITE', 'ACCESSIBLE'] as const;
  const bedConfigs = ['QUEEN', 'KING', 'TWIN_BEDS', 'QUEEN_PLUS_SOFA'] as const;
  const statuses = ['VACANT_CLEAN', 'VACANT_DIRTY', 'OCCUPIED_CLEAN', 'OCCUPIED_DIRTY'] as const;
